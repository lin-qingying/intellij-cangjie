...
import cn.cangnova.cangjie.psi.doNotAnalyze
import cn.cangnova.cangjie.psi.psiUtil.CjStubbedPsiUtil
import cn.cangnova.cangjie.utils.ExtensionProvider
...
//    private val diagnosticSuppressors: List< DiagnosticSuppressor> = project?.let { org.jetbrains.kotlin.resolve.diagnostics.DiagnosticSuppressor.getInstances(it) } ?: emptyList()
...
interface DiagnosticSuppressor {
    ...
    companion object {
        val EP_NAME: ExtensionPointName<DiagnosticSuppressor> =
            ExtensionPointName.create("cn.cangnova.cangjie.diagnosticSuppressor")
    }
}
