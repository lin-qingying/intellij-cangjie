...
import cn.cangnova.cangjie.diagnostics.rendering.DiagnosticFactoryToRendererMap;
...
import static cn.cangnova.cangjie.descriptors.PositioningStrategies.*;
import static cn.cangnova.cangjie.diagnostics.Severity.*;
...
public interface Errors {
    ...
    DiagnosticFactory0<CjPostfixExpression> DEPRECATED_SYNTAX_WITH_DEFINITELY_NOT_NULL = DiagnosticFactory0.create(WARNING);
