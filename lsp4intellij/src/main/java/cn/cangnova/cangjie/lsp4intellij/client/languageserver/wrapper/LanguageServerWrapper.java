 ...
 */
package cn.cangnova.cangjie.lsp4intellij.client.languageserver.wrapper;
...
import cn.cangnova.cangjie.lsp4intellij.IntellijLanguageClient;
import cn.cangnova.cangjie.lsp4intellij.client.DefaultLanguageClient;
import cn.cangnova.cangjie.lsp4intellij.client.ServerWrapperBaseClientContext;
import cn.cangnova.cangjie.lsp4intellij.client.languageserver.ServerOptions;
import cn.cangnova.cangjie.lsp4intellij.client.languageserver.ServerStatus;
import cn.cangnova.cangjie.lsp4intellij.client.languageserver.requestmanager.DefaultRequestManager;
import cn.cangnova.cangjie.lsp4intellij.client.languageserver.requestmanager.RequestManager;
import cn.cangnova.cangjie.lsp4intellij.client.languageserver.serverdefinition.LanguageServerDefinition;
import cn.cangnova.cangjie.lsp4intellij.editor.EditorEventManager;
import cn.cangnova.cangjie.lsp4intellij.editor.EditorEventManagerBase;
import cn.cangnova.cangjie.lsp4intellij.extensions.LSPExtensionManager;
import cn.cangnova.cangjie.lsp4intellij.listeners.DocumentListenerImpl;
import cn.cangnova.cangjie.lsp4intellij.listeners.EditorMouseListenerImpl;
import cn.cangnova.cangjie.lsp4intellij.listeners.EditorMouseMotionListenerImpl;
import cn.cangnova.cangjie.lsp4intellij.listeners.LSPCaretListenerImpl;
import cn.cangnova.cangjie.lsp4intellij.requests.Timeouts;
import cn.cangnova.cangjie.lsp4intellij.statusbar.LSPServerStatusWidget;
import cn.cangnova.cangjie.lsp4intellij.statusbar.LSPServerStatusWidgetFactory;
import cn.cangnova.cangjie.lsp4intellij.utils.FileUtils;
import cn.cangnova.cangjie.lsp4intellij.utils.LSPException;
...
import static cn.cangnova.cangjie.lsp4intellij.client.languageserver.ServerStatus.INITIALIZED;
import static cn.cangnova.cangjie.lsp4intellij.client.languageserver.ServerStatus.STARTED;
import static cn.cangnova.cangjie.lsp4intellij.client.languageserver.ServerStatus.STARTING;
import static cn.cangnova.cangjie.lsp4intellij.client.languageserver.ServerStatus.STOPPED;
import static cn.cangnova.cangjie.lsp4intellij.client.languageserver.ServerStatus.STOPPING;
import static cn.cangnova.cangjie.lsp4intellij.requests.Timeout.getTimeout;
import static cn.cangnova.cangjie.lsp4intellij.requests.Timeouts.INIT;
import static cn.cangnova.cangjie.lsp4intellij.requests.Timeouts.SHUTDOWN;
...
import static cn.cangnova.cangjie.lsp4intellij.utils.FileUtils.editorToProjectFolderUri;
import static cn.cangnova.cangjie.lsp4intellij.utils.FileUtils.editorToURIString;
import static cn.cangnova.cangjie.lsp4intellij.utils.FileUtils.reloadEditors;
import static cn.cangnova.cangjie.lsp4intellij.utils.FileUtils.sanitizeURI;
    ...
    public ServerCapabilities getServerCapabilities() {
        if (initializeResult != null)
            ...
            try {
                ...
                // Modified by LinQingYing: Set capabilitiesAlreadyRequested flag to true after initialization
