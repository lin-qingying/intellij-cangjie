...
public class FileUtils {
     ...
     * <p>
     * Modified by Cangjie: Enhanced Windows URI handling to:
     * 1. Convert drive letters to lowercase for consistency (e.g. C: -> c:)
     * 2. Properly escape colons in paths (e.g. c: -> c%3A)
     * 3. Handle edge cases with encoded colons and path separators
     * These modifications ensure better compatibility with language servers and follow URI standards.
     *
     *
     *
     */
