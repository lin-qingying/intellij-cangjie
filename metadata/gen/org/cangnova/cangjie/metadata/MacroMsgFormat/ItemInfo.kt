...
class ItemInfo : Table() {
    ...
    fun __assign(_i: Int, _bb: ByteBuffer) : ItemInfo {
        __init(_i, _bb)
        return this
    }
    val key : String?
    ...
    companion object {
        ...
        fun getRootAsItemInfo(_bb: ByteBuffer): ItemInfo = getRootAsItemInfo(_bb, ItemInfo())
        fun getRootAsItemInfo(_bb: ByteBuffer, obj: ItemInfo): ItemInfo {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun createItemInfo(builder: FlatBufferBuilder, keyOffset: Int, valueType: UByte, valueOffset: Int) : Int {
        ...
        fun startItemInfo(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun endItemInfo(builder: FlatBufferBuilder) : Int {
