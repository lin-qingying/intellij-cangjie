...
import org.cangnova.cangjie.debugger.protobuf.breakpoint.SymbolicBreakpointType.ID
...
object SymbolicBreakpointType : XBreakpointType<SymbolicBreakpointXBreakpoint, SymbolicBreakpointType.Properties>(
    ID,
    ProtoDebuggerBundle.message("proto.breakpoint.symbolic.title")
) {
    ...
    override fun getGeneralDescription(breakpoint: SymbolicBreakpointXBreakpoint): String {
        ...
        return ProtoDebuggerBundle.message(
            "proto.breakpoint.symbolic.description",
