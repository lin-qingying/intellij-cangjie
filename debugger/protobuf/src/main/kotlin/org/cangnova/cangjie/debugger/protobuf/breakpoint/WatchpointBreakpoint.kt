...
class WatchpointBreakpoint(
     ...
     */
    fun toLLAccessType(): org.cangnova.cangjie.debugger.protobuf.data.LLDBWatchpoint.AccessType =
        properties.toLLAccessType()
    ...
    companion object {
        ...
        fun createReadWriteWatchpoint(
            ...
            return create(
                expression,
                WatchpointBreakpointType.ACCESS_TYPE_READ_WRITE,
                enabled,
                SuspendPolicy.ALL,
                condition
            )
