...
import org.cangnova.cangjie.debugger.protobuf.breakpoint.WatchpointBreakpointType.ID
...
object WatchpointBreakpointType : XBreakpointType<WatchpointBreakpoint, WatchpointBreakpointType.Properties>(
    ID,
    ProtoDebuggerBundle.message("proto.breakpoint.watchpoint.title")
) {
    ...
    override fun getGeneralDescription(breakpoint: WatchpointBreakpoint): String {
        val props = breakpoint.properties
        return ProtoDebuggerBundle.message(
            "proto.breakpoint.watchpoint.description",
            props.getExpression()
        )
    }
