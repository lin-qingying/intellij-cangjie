...
private class ImmutableUserDisabledFeatures(
    override val pkgRootToDisabledFeatures: Map<VirtualFile, Set<FeatureName>>
) : UserDisabledFeatures()

class MutableUserDisabledFeatures(
    override val pkgRootToDisabledFeatures: MutableMap<VirtualFile, MutableSet<FeatureName>>
) : UserDisabledFeatures() {
    ...
    fun setFeatureState(
        ...
        val packageRoot = feature.model.rootDir
        when (state) {
