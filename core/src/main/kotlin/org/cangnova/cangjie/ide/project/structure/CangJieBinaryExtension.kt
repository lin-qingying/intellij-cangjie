...
package org.cangnova.cangjie.ide.project.structure
...
abstract class CangJieBinaryExtension(val fileType: FileType) {
    companion object {
        val EP_NAME: ExtensionPointName<CangJieBinaryExtension> = ExtensionPointName.create("org.cangnova.cangjie.binaryExtension")
