...
package org.cangnova.cangjie.protodebugger.pty
 ...
 */
@Deprecated(
    message = "使用 WindowsPty 替代，提供更完善的PTY功能",
    replaceWith = ReplaceWith("WindowsPty", "org.cangnova.cangjie.protodebugger.pty.WindowsPty"),
