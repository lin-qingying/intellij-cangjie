...
class CangJieLLDBParserDefinition : ParserDefinition {
    ...
    companion object {
        val FILE = IFileElementType(CangJieDebugLLDBLanguage)
    }
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile {
        return object : com.intellij.extapi.psi.PsiFileBase(viewProvider, CangJieDebugLLDBLanguage) {
            override fun getFileType() = CangJieLLDBFileType
