...
import org.cangnova.cangjie.serialization.deserialization.descriptors.DeserializedEnumDescriptor
...
class EnumDeserializer(private val components: DeserializationComponents) {
    ...
    private fun createEnum(key: ClassKey): EnumDescriptor? {
        ...
        val outerContext = if (outerClassId != null) {
            val outerClass = deserializeEnum(outerClassId) as? DeserializedEnumDescriptor ?: return null
        ...
        return DeserializedEnumDescriptor(outerContext, decl as EnumWrapper, metadataVersion, sourceElement)
