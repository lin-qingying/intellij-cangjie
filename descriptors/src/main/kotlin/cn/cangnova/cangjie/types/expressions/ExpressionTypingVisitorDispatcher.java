package cn.cangnova.cangjie.types.expressions;//package cn.cangnova.cangjie.types.expressions;
//
//import cn.cangnova.cangjie.descriptors.PsiDiagnosticUtils;
//import cn.cangnova.cangjie.diagnostics.Errors;
//import cn.cangnova.cangjie.psi.*;
//import cn.cangnova.cangjie.psi.codeFragmentUtil.CodeFragmentUtilKt;
//import cn.cangnova.cangjie.resolve.AnnotationChecker;
//import cn.cangnova.cangjie.resolve.BindingContext;
//import cn.cangnova.cangjie.resolve.BindingContextUtils;
//import cn.cangnova.cangjie.resolve.BindingContextUtilsKt;
...
//import cn.cangnova.cangjie.types.expressions.match.PatternMatchingTypingVisitor;
...
//import cn.cangnova.cangjie.utils.CangJieFrontEndException;
...
//
//import static cn.cangnova.cangjie.types.util.TypeUtils.EXPRESSION_TYPE;
...
//
//    @Override
//    public @NotNull CangJieTypeInfo getTypeInfoByCaseEnum(@NotNull CjExpression expression, List<? extends ValueArgument> argument, ExpressionTypingContext context,
...
//
//        @Override
//        public @NotNull CangJieTypeInfo getTypeInfoByCaseEnum(@NotNull CjExpression expression, @NotNull List<? extends ValueArgument> argument, @Nullable ExpressionTypingContext context, boolean isReportError) {
//            return null;
//        }
//    }
