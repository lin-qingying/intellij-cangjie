...
import cn.cangnova.cangjie.resolve.extensions.AssignResolutionAltererExtension;
...
import static cn.cangnova.cangjie.psi.CjPsiUtil.deparenthesize;
import static cn.cangnova.cangjie.resolve.BindingContext.AMBIGUOUS_REFERENCE_TARGET;
import static cn.cangnova.cangjie.resolve.BindingContext.VARIABLE_REASSIGNMENT;
import static cn.cangnova.cangjie.resolve.calls.context.ContextDependency.INDEPENDENT;
import static cn.cangnova.cangjie.types.util.TypeUtils.NO_EXPECTED_TYPE;
import static cn.cangnova.cangjie.types.util.TypeUtils.noExpectedType;
import static cn.cangnova.cangjie.utils.exceptions.OperatorConventions.getNameForOperationSymbol;
