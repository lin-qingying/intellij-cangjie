...
import static cn.cangnova.cangjie.resolve.OverridingUtil.OverrideCompatibilityInfo.Result.*;
...
public class OverridingUtil {
    ...
    private static Modality determineModalityForFakeOverride(
        ...
        boolean transformAbstractToClassModality =
                  (Modality.ABSTRACT != current.getModality() && Modality.SEALED != current.getModality());
...
//        排除来自扩展的方法
    ...
    public OverrideCompatibilityInfo isOverridableBy(
        ...
        for (ExternalOverridabilityCondition externalCondition : EXTERNAL_CONDITIONS) {
            ...
            if (wasSuccess && ExternalOverridabilityCondition.Contract.SUCCESS_ONLY == externalCondition.contract)
                continue;
