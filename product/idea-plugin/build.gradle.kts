...
dependencies {
    ...
    runtimeOnly(libs.cangjieCodeInsightForIde)
    runtimeOnly(libs.cangjieCodeInsightFormattingForIde)
    runtimeOnly(libs.cangjieCodeInsightFoldingForIde)
    runtimeOnly(libs.cangjieCodeInsightHighlightingForIde)
    runtimeOnly(libs.cangjieCodeInsightRefactoringForIde)
