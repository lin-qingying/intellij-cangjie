 ...
 * ```
 *
 * ## 与 CjAnnotationEntry 的关系
 * - **CjAnnotation**: 注解容器,是 PSI 树中的组织节点,可包含多个注解条目
 * - **CjAnnotationEntry**: 单个注解使用,是实际的注解应用
 *
 * ## PSI 树结构示例
 * ```
 * CjModifierList
 ...
 * 无需直接操作 CjAnnotation 容器。容器主要用于内部 PSI 树管理。
 *
 * @see CjAnnotationEntry 单个注解条目
