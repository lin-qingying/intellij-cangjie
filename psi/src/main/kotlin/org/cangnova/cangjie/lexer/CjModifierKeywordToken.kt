...
class CjModifierKeywordToken : CjKeywordToken {
    @Deprecated("")
    private constructor(debugName: @NonNls String, value: @NonNls String, isSoft: Boolean) : super(
        debugName,
        value,
        isSoft
    )

    private constructor(debugName: @NonNls String, value: @NonNls String, isSoft: Boolean, tokenId: Int) : super(
        debugName,
        value,
        isSoft,
        tokenId
