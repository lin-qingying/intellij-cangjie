 ...
 * 例如：查找所有名为 "name" 的字段
 */
class CangJieFieldShortNameIndex internal constructor() : StringStubIndexExtension<CjFieldVariable>() {
    ...
    override fun get(shortName: String, project: Project, scope: GlobalSearchScope): Collection<CjFieldVariable> {
