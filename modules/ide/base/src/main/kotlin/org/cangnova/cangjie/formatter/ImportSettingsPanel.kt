...
private class ImportSettingsPanel {
    ...
    private val nameCountToUseStarImportSelector = NameCountToUseStarImportSelector(
        CangJieFormatterBundle.message("formatter.title.top.level.symbols"),
    ...
    private val nameCountToUseStarImportForMembersSelector = NameCountToUseStarImportSelector(
        CangJieFormatterBundle.message("formatter.title.java.statics.and.enum.members"),
    ...
    val panel = panel {
        ...
        group(CangJieFormatterBundle.message("formatter.title.other")) {
            row {
                cbImportNestedClasses =
                    checkBox(CangJieFormatterBundle.message("formatter.checkbox.text.insert.imports.for.nested.classes"))
                        .component
            }
        }
    ...
    class NameCountToUseStarImportSelector(
        ...
        fun Panel.buildUi() {
            buttonsGroup(title) {
                row {
                    rbUseSingleImports =
                        radioButton(CangJieFormatterBundle.message("formatter.button.text.use.single.name.import"))
                            .component
                }
                row {
                    rbUseStarImports = radioButton(CangJieFormatterBundle.message("formatter.button.text.use.import.with"))
                        .component
                }
                row {
                    rbUseStarImportsIfAtLeast =
                        radioButton(CangJieFormatterBundle.message("formatter.button.text.use.import.with.match.at.least"))
                            .gap(RightGap.SMALL)
                            .component
                    starImportLimitField = spinner(MIN_VALUE..MAX_VALUE)
                        ...
                        .component
                    label(CangJieFormatterBundle.message("formatter.text.names.used"))
                }
            }
        }
