...
interface CangJieIdeDescriptorRendererHighlightingManager<TAttributes : CangJieIdeDescriptorRendererHighlightingManager.Companion.Attributes> {
    ...
    val asNonOptionalAssertion: TAttributes

    val asOptionalMarker: TAttributes
    ...
    val asStructName: TAttributes
    val asEnumName: TAttributes
    val asInterfaceName: TAttributes
    val asInstanceProperty: TAttributes
    val asInstanceVariable: TAttributes
    ...
    companion object {
        ...
        val NO_HIGHLIGHTING = object : CangJieIdeDescriptorRendererHighlightingManager<Attributes> {
            ...
            override val asDoubleArrow: Attributes  = EMPTY_ATTRIBUTES
            ...
            override val asNonOptionalAssertion = EMPTY_ATTRIBUTES
            override val asOptionalMarker = EMPTY_ATTRIBUTES
            ...
            override val asStructName = EMPTY_ATTRIBUTES
            override val asEnumName: Attributes  = EMPTY_ATTRIBUTES
            override val asInterfaceName: Attributes  = EMPTY_ATTRIBUTES
            override val asInstanceProperty = EMPTY_ATTRIBUTES
            override val asInstanceVariable: Attributes  = EMPTY_ATTRIBUTES
