...
public class CjImportSpecifiedImpl extends CjElementImpl implements CjImportSpecified {

  public CjImportSpecifiedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CjVisitor visitor) {
    visitor.visitImportSpecified(this);
  }
