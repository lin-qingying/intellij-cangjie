...
sealed class BreakpointEventReason {
    @Serializable
    data object changed : BreakpointEventReason()

    @Serializable
    data object new : BreakpointEventReason()

    @Serializable
    data object removed : BreakpointEventReason()

    @Serializable
    data class Other(val value: String) : BreakpointEventReason()
}
