...
import org.cangnova.cangjie.cjpm.project.model.AttachCjpmProjectAction
...
import org.cangnova.cangjie.cjpm.project.model.isCjpmToml
...
class NoCjpmProjectNotificationProvider(project: Project) : CjNotificationProvider(project) {
    ...
    private fun createAttachCjpmProjectPanel(
        debugId: String,
        file: VirtualFile,
        @NlsContexts.LinkLabel message: String
    ): CjEditorNotificationPanel =
    ...
    companion object {
        private const val NOTIFICATION_STATUS_KEY = "org.cangnova.cangjie.hideNoCjpmProjectNotifications"
