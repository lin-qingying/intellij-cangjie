        ...
        companion object {
            fun serialization(filePath: Path): Project {
                ...
                if (file.name == "cjpm.lock") {
                    ...
                    val jsonString =
                        org.cangnova.cangjie.toolchain.tools.Cjpm.Companion.JSON_MAPPER.writeValueAsString(toml.toMap())

                    return org.cangnova.cangjie.toolchain.tools.Cjpm.Companion.JSON_MAPPER.readValue(
                        jsonString,
                        Project::class.java
                    )
