...
import org.cangnova.cangjie.cjpm.project.workspace.CjpmWorkspaceData
import org.cangnova.cangjie.ide.experiments.CjExperiments
import org.cangnova.cangjie.ide.module.CjProcessResult
import org.cangnova.cangjie.ide.run.cjpm.CjpmCommandLine
import org.cangnova.cangjie.ide.run.cjpm.CjpmPatch
import org.cangnova.cangjie.ide.run.cjpm.runconfig.*
import org.cangnova.cangjie.ide.run.isFeatureEnabled
import org.cangnova.cangjie.lang.CjConstants.LIB_CJ_FILE
import org.cangnova.cangjie.lang.CjConstants.MAIN_CJ_FILE
import org.cangnova.cangjie.toolchain.parseSemVer
import org.cangnova.cangjie.utils.buildList
...
class Cjpm(
    toolchain: org.cangnova.cangjie.toolchain.CjToolchainBase
...
//        return CjResult.Ok(ProjectDescription(workspaceData, status))
        val workspaceData = org.cangnova.cangjie.toolchain.impl.CjpmMetadata.clean(rawData)
    ...
    fun fetchMetadata(
        ...
        ): CjResult<org.cangnova.cangjie.toolchain.impl.CjpmMetadata.Project, CjProcessExecutionOrDeserializationException> {
     ...
     */
    private fun readFile(projectDirectory: Path): org.cangnova.cangjie.toolchain.impl.CjpmMetadata.Project {
...
//        val path = projectDirectory.resolve(CjpmConstantsService(toolchain = toolchain).LOCK_FILE)
        ...
        if (path.exists()) {
            val project = org.cangnova.cangjie.toolchain.impl.CjpmMetadata.Project.serialization(path)
...
//            .registerCangJieModule()
        ...
        @JvmStatic
        val TEST_NOCAPTURE_ENABLED_KEY: RegistryValue = Registry.get("org.cangnova.cangjie.cjpm.test.nocapture")
