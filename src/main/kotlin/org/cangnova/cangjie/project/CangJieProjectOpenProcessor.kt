...
class CangJieProjectOpenProcessor : ProjectOpenProcessor() {
    override val name: @Nls String = "CangJie"
    ...
    override fun doOpenProject(
        ...
        return PlatformProjectOpenProcessor.getInstance().doOpenProject(basedir, projectToClose, forceOpenInNewFrame)
            ?.also {
                ...
                val projectService = projectToClose?.let { CjProjectsService.getInstance(it) }
                projectService?.discoverProject(basedir)
            }
