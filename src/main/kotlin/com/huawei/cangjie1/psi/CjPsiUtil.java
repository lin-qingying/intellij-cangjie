...
public class CjPsiUtil {
    ...
    @Nullable
    public static CjClassOrObject getClassIfParameterIsProperty(@NotNull CjParameter cjParameter) {
        if (cjParameter.hasValOrVar()) {
            ...
            if (grandParent instanceof CjPrimaryConstructor) {
                return ((CjPrimaryConstructor) grandParent).getContainingClassOrObject();
            }
        }
