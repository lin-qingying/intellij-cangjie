...
import com.huawei.cangjie1.lang.CangJieFileType;
...
import com.huawei.cangjie1.utils.exceptions.OperatorConventions;
...
abstract class CjNamedDeclarationStub<T extends CangJieStubWithFqName<?>> extends CjDeclarationStub<T> implements CjNamedDeclaration {
    ...
    public SearchScope getUseScope() {
        ...
        if (hasModifier(CjTokens.PRIVATE_KEYWORD)) {
            CjElement containingClass = PsiTreeUtil.getParentOfType(this, CjClassOrObject.class);

            if (containingClass != null) {
                return new LocalSearchScope(containingClass);
            }
            CjFile CjFile = getContainingCjFile();
            if (this instanceof CjClassOrObject) {
                // Private top-level class may be used in non-CangJie JVM code
                ...
                SearchScope nonCangJieJvmScope = GlobalSearchScope.notScope(CangJieFilesScope).intersectWith(jvmScope);
        ...
        CjClassOrObject classOrObject = CjPsiUtilKt.getContainingClassOrObject(this);
