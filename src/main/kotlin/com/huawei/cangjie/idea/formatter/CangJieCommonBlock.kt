...
import com.huawei.cangjie.idea.formatter.NodeIndentStrategy.Companion.strategy
import com.huawei.cangjie.idea.formatter.util.TrailingCommaHelper.trailingCommaExistsOrCanExist
...
private val INDENT_RULES = arrayOf(
    ...
    strategy("Indent for parts")
        ...
        .notForType(BLOCK, FUNC_KEYWORD, LET_KEYWORD, VAR_KEYWORD, INIT_KEYWORD, RPAR, EOL_COMMENT, CONTEXT_RECEIVER_LIST, MODIFIER_LIST)
