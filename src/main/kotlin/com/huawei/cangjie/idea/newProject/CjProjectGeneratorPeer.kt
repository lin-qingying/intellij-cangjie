...
import com.huawei.cangjie.idea.newProject.ui.CjNewProjectPanel
...
class CjProjectGeneratorPeer(cjpmProjectDir: Path = Paths.get(".")) : GeneratorPeerImpl<ConfigurationData>() {
    ...
    private val newProjectPanel = CjNewProjectPanel(showProjectTypeSelection = false, cjpmProjectDir) { checkValid?.run() }
