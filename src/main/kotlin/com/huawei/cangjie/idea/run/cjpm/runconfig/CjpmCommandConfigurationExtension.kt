...
import com.huawei.cangjie.idea.run.cjpm.ConfigurationExtensionContext
...
abstract class CjpmCommandConfigurationExtension: RunConfigurationExtensionBase<CjpmCommandConfiguration>() {
    ...
    companion object{
        val EP_NAME = ExtensionPointName.create<CjpmCommandConfigurationExtension>("com.huawei.cangjie.runConfigurationExtension")
