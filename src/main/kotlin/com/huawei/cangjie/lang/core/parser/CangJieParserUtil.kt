...
//     * access syntax (see https://github.com/intellij-cangjie/intellij-cangjie/issues/6029)
//     *
...
//        }
//
//        put(CangJieParser::ExprMacroArgument, true, "dbg")
//        put(
//            CangJieParser::FormatMacroArgument, true, "format", "format_args", "format_args_nl", "write", "writeln",
//            "print", "println", "eprint", "eprintln", "panic", "unimplemented", "unreachable", "todo"
//        )
//        put(
//            CangJieParser::AssertMacroArgument, true, "assert", "debug_assert", "assert_eq", "assert_ne",
//            "debug_assert_eq", "debug_assert_ne"
//        )
//        put(CangJieParser::VecMacroArgument, true, "vec")
//        put(CangJieParser::IncludeMacroArgument, true, "include_str", "include_bytes")
//        put(CangJieParser::IncludeMacroArgument, false, "include")
//        put(CangJieParser::ConcatMacroArgument, true, "concat")
//        put(CangJieParser::EnvMacroArgument, true, "env")
//        put(CangJieParser::AsmMacroArgument, true, "asm")
//    }
//
...
//        if (mode.attrsAndVis && !CangJieParser.AttrsAndVis(b, level + 1)) return false
//
//        if (!CangJieParser.PathWithoutTypeArgs(b, level + 1) || !consumeToken(b, EXCL)) {
//            return false
//        }
//
...
//                    b.error(CjBundle.message("parsing.error.expected.got2", b.tokenText?:""))
//                    return mode.pin
//                }
//                return true
//            }
...
//            b.error(CjBundle.message("parsing.error.macro.argument.expected.got", b.tokenText?:""))
//            return mode.pin
//        }
//        if (braceKind.needsSemicolon && mode.semicolon && !consumeToken(b, SEMICOLON)) {
//            b.error(CjBundle.message("parsing.error.expected.got", b.tokenText?:""))
//            return mode.pin
//        }
//        return true
//    }
...
//                b.error(CjBundle.message("parsing.error.expected2", leftBrace.closeText))
...
//                b.advanceLexer() // Consume '}' or ')' or ']'
//            } else {
//                b.error(CjBundle.message("parsing.error.expected", leftBrace.closeText))
...
//        return CangJieParser.SimplePat(builder, 0)
//    }
//
