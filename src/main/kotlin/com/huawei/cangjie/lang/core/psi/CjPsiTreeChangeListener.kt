...
sealed class CjPsiTreeChangeEvent {
...
abstract class CjPsiTreeChangeAdapter : PsiTreeChangeListener {

    abstract fun handleEvent(event: CjPsiTreeChangeEvent)

    override fun beforePropertyChange(event: PsiTreeChangeEvent) {
        handleEvent(
            CjPsiTreeChangeEvent.PropertyChange.Before(
                event.propertyName,
                event.oldValue,
                event.newValue,
                event.element,
    ...
    override fun propertyChanged(event: PsiTreeChangeEvent) {
        handleEvent(
            CjPsiTreeChangeEvent.PropertyChange.After(
                event.propertyName,
                event.oldValue,
                event.newValue,
                event.element,
    ...
    override fun beforeChildReplacement(event: PsiTreeChangeEvent) {
        handleEvent(
            CjPsiTreeChangeEvent.ChildReplacement.Before(
                event.file,
                event.parent,
                event.oldChild,
                event.newChild
    ...
    override fun childReplaced(event: PsiTreeChangeEvent) {
        handleEvent(
            CjPsiTreeChangeEvent.ChildReplacement.After(
                event.file,
                event.parent,
                event.oldChild,
                event.newChild
    ...
    override fun beforeChildAddition(event: PsiTreeChangeEvent) {
        handleEvent(
            CjPsiTreeChangeEvent.ChildAddition.Before(
                event.file,
                event.parent,
                event.child
            )
    ...
    override fun childAdded(event: PsiTreeChangeEvent) {
        handleEvent(
            CjPsiTreeChangeEvent.ChildAddition.After(
                event.file,
                event.parent,
                event.child
            )
    ...
    override fun beforeChildMovement(event: PsiTreeChangeEvent) {
        handleEvent(
            CjPsiTreeChangeEvent.ChildMovement.Before(
                event.file,
                event.oldParent,
                event.newParent,
                event.child
    ...
    override fun childMoved(event: PsiTreeChangeEvent) {
        handleEvent(
            CjPsiTreeChangeEvent.ChildMovement.After(
                event.file,
                event.oldParent,
                event.newParent,
                event.child
    ...
    override fun beforeChildRemoval(event: PsiTreeChangeEvent) {
        handleEvent(
            CjPsiTreeChangeEvent.ChildRemoval.Before(
                event.file,
                event.parent,
                event.child
            )
    ...
    override fun childRemoved(event: PsiTreeChangeEvent) {
        handleEvent(
            CjPsiTreeChangeEvent.ChildRemoval.After(
                event.file,
                event.parent,
                event.child
            )
    ...
    override fun beforeChildrenChange(event: PsiTreeChangeEvent) {
        handleEvent(
            CjPsiTreeChangeEvent.ChildrenChange.Before(
                event.file,
                event.parent,
    ...
    override fun childrenChanged(event: PsiTreeChangeEvent) {
        handleEvent(
            CjPsiTreeChangeEvent.ChildrenChange.After(
                event.file,
                event.parent,
                (event as? PsiTreeChangeEventImpl)?.isGenericChange == true
            )
