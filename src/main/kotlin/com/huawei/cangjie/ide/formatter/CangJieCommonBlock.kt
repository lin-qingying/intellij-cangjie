...
import com.huawei.cangjie.ide.formatter.NodeIndentStrategy.Companion.strategy
import com.huawei.cangjie.ide.formatter.util.TrailingCommaHelper.trailingCommaExistsOrCanExist
...
private val ALIGN_FOR_BINARY_OPERATIONS = TokenSet.create(MUL, DIV, PERC, PLUS, MINUS, LT, GT, LTEQ, GT_EQ, ANDAND, OROR)
