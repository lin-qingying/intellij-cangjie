...
import com.huawei.cangjie.analyzer.api.CjDeclarationRendererForSource
import com.huawei.cangjie.analyzer.api.CjDeclarationSymbol
import com.huawei.cangjie.analyzer.api.CjSymbol
import com.huawei.cangjie.analyzer.api.prettyPrint
...
private fun @receiver:Nls StringBuilder.renderCangJieDeclaration(
    ...
    symbolFinder: CjAnalysisSession.(CjSymbol) -> CjSymbol? = { it },
