...
private val LOG = Logger.getInstance("#com.huawei.cangjie.ide.refactoring.move.MoveUtil")
...
internal fun addDelayedImportRequest(elementToImport: PsiElement, file: CjFile) {
    com.huawei.cangjie.ide.codeinsight.shorten.addDelayedImportRequest(elementToImport, file)
}
