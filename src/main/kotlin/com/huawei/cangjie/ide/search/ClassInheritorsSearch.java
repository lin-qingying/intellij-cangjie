...
public final class ClassInheritorsSearch extends ExtensibleQueryFactory<CjTypeStatement, ClassInheritorsSearch.SearchParameters> {
    public static final ExtensionPointName<QueryExecutor<CjTypeStatement, ClassInheritorsSearch.SearchParameters>> EP_NAME = ExtensionPointName.create("com.huawei.cangjie.ide.search.classInheritorsSearch");
