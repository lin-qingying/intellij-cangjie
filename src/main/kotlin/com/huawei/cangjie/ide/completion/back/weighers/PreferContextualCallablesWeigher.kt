...
//    fun addWeight(lookupElement: LookupElement, symbol: CjCallableSymbol, contextualSymbolsCache: WeighingContext.ContextualSymbolsCache) {
//        if (symbol !is CjNamedSymbol || symbol.name !in contextualSymbolsCache) return
//
