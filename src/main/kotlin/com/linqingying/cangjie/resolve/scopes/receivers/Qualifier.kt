...
class TypeAliasQualifier(
    ...
    /**
     * We cannot use [com.linqingying.cangjie.descriptors.ClassDescriptor.getUnsubstitutedMemberScope] directly,
     ...
     * that's why we use [com.linqingying.cangjie.descriptors.ClassDescriptor.getUnsubstitutedMemberScope],
