...
object DescriptorEquivalenceForOverrides {
    ...
    fun areEquivalent(
        ...
        return when {
            ...
            a is CallableDescriptor && b is CallableDescriptor -> areCallableDescriptorsEquivalent(
                ...
                cangjieTypeRefiner = CangJieTypeRefiner.Default
            )
    ...
    fun areCallableDescriptorsEquivalent(
        ...
        if (distinguishExpectsAndNonExpects && a is MemberDescriptor && b is MemberDescriptor) return false
        ...
        val overridingUtil = OverridingUtil.create(cangjieTypeRefiner) eq@{ c1, c2 ->
        ...
        return overridingUtil.isOverridableBy(
            a,
            b,
            null,
            !ignoreReturnType
        ).result == OverridingUtil.OverrideCompatibilityInfo.Result.OVERRIDABLE
                && overridingUtil.isOverridableBy(
            b,
            a,
            null,
            !ignoreReturnType
