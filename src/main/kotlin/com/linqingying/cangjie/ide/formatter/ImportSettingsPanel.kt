...
class ImportSettingsPanelWrapper(settings: CodeStyleSettings) : CodeStyleAbstractPanel(CangJieLanguage, null, settings) {
...
private class ImportSettingsPanel {
  ...
  val panel = panel {
    ...
    group(CangJieBundle.message("formatter.title.other")) {
      row {
        cbImportNestedClasses = checkBox(CangJieBundle.message("formatter.checkbox.text.insert.imports.for.nested.classes"))
          .component
      }
    }
  ...
  class NameCountToUseStarImportSelector(private val title: @NlsContexts.BorderTitle String, private val default: Int) {
    ...
    fun Panel.buildUi() {
      buttonsGroup(title) {
        row {
          rbUseSingleImports = radioButton(CangJieBundle.message("formatter.button.text.use.single.name.import"))
            .component
        }
        row {
        ...
        row {
          rbUseStarImportsIfAtLeast = radioButton(CangJieBundle.message("formatter.button.text.use.import.with.match.at.least"))
            .gap(RightGap.SMALL)
            .component
