...
//      val obeyingResult = PolicyDrivenResultSet(result, policyController)
//      val obeyingResult = PolicyDrivenResultSetTest(result, )
            ...
            policyController.invokeWithPolicy(policyWhileGenerating) {
                kindCollector.collectKinds(parameters, executor, result)
            }
        }
    }
    ...
    companion object {
        private val EP_NAME =
            ExtensionPointName<SmartPipelineRunner>("com.linqingying.cangjie.ide.completion.turboComplete.smartPipelineRunner")
