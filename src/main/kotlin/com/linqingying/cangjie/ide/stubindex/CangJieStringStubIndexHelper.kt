...
import com.linqingying.cangjie.ide.indices.getByKeyAndMeasure
import com.linqingying.cangjie.ide.indices.processElementsAndMeasure
...
inline fun <T> measureIndexCall(
    index: StubIndexKey<*, *>, prefix: String, threshold: Duration, log: Logger, crossinline block: () -> T
): T {
