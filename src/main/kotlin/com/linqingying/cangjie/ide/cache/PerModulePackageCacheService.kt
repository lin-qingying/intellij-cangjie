...
import com.linqingying.cangjie.ide.cache.PerModulePackageCacheService.Companion.DEBUG_LOG_ENABLE_PerModulePackageCache
...
import com.linqingying.cangjie.ide.projectStructure.firstOrNull
import com.linqingying.cangjie.ide.projectStructure.moduleInfoOrNull
        ...
        if (pendingVFileChanges.size + pendingCjFileChanges.size >= FULL_DROP_THRESHOLD) {
            ...
            pendingVFileChanges.processPending { event ->
                ...
                if (vfile.isDirectory || !vfile.isValid) {
                    ...
                    (infoByVirtualFile as? CangJieModuleInfo)?.let {
                        invalidateCacheForModuleInfo(it)
                    }
                }
            ...
            pendingCjFileChanges.processPending { file ->
                ...
                (nullableModuleInfo as? CangJieModuleInfo)?.let { invalidateCacheForModuleInfo(it) }
                if (nullableModuleInfo == null || nullableModuleInfo !is CangJieModuleInfo) {
