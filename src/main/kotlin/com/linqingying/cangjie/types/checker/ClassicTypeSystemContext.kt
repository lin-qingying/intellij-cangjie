...
import com.linqingying.cangjie.builtins.StandardNames.FqNames
...
import com.linqingying.cangjie.descriptors.isFinalClass
import com.linqingying.cangjie.name.FqName
import com.linqingying.cangjie.name.SpecialNames
import com.linqingying.cangjie.resolve.DescriptorUtils
import com.linqingying.cangjie.resolve.calls.inference.CapturedType
...
import com.linqingying.cangjie.resolve.scopes.SubstitutingScope
...
import com.linqingying.cangjie.types.util.isStubTypeForVariableInSubtyping as isSimpleTypeStubTypeForVariableInSubtyping
...
//    }
    ...
    override fun captureFromArguments(type: SimpleTypeMarker, status: CaptureStatus): SimpleTypeMarker? {
        ...
        return com.linqingying.cangjie.types.checker.captureFromArguments(type, status)
    }
    ...
    override fun intersectTypes(types: List<CangJieTypeMarker>): CangJieTypeMarker {
        ...
        return com.linqingying.cangjie.types.checker.intersectTypes(types as List<UnwrappedType>)
    }

    override fun intersectTypes(types: List<SimpleTypeMarker>): SimpleTypeMarker {
        @Suppress("UNCHECKED_CAST")
        return com.linqingying.cangjie.types.checker.intersectTypes(types as List<SimpleType>)
    }
