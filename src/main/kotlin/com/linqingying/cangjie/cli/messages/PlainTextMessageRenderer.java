...
import com.linqingying.cangjie.utils.CapitalizeDecapitalizeKt;
...
import static com.linqingying.cangjie.cli.messages.CompilerMessageSeverity.*;
...
public abstract class PlainTextMessageRenderer implements MessageRenderer {
    ...
    static {
        ...
        if (!PropertiesKt.isWindows() && "true".equals(CompilerSystemProperties.CANGJIE_COLORS_ENABLED_PROPERTY.getValue())) {
            try {
