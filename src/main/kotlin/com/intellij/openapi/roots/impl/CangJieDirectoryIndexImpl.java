...
/**
 * This is an internal class, {@link CangJieDirectoryIndex} must be used instead.
 */

public final class CangJieDirectoryIndexImpl extends CangJieDirectoryIndex implements Disposable {
  private static final Logger LOG = Logger.getInstance(CangJieDirectoryIndexImpl.class);
  ...
  public CangJieDirectoryIndexImpl(@NotNull Project project) {
