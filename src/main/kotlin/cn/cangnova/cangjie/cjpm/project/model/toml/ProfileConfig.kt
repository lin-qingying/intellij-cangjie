...
data class ProfileConfig(
    ...
    /** 自定义透传给 cjc 的选项 */
    @JsonProperty("customized-option")
...
data class TestProfileConfig(
    /** 指定执行结果在控制台中是否无颜色显示 */
    @JsonProperty("no-color")
    val noColor: Boolean? = null,
    /** 为每个测试用例指定默认的超时时间 */
    @JsonProperty("timeout-each")
