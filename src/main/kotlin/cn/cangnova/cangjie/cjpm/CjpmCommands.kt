...
package cn.cangnova.cangjie.cjpm
...
enum class CjpmCommands(val description: String, val options: List<CjpmOption>) {
    ...
    BUILD(
        ...
        options = listOf(
            ...
            CjpmOption(
                "target ",
                """"交叉编译代码到目标平台，module.json 中的配置可参考 cross_compile_configuration 部分"""
            ),
            CjpmOption("help", """帮助"""),
