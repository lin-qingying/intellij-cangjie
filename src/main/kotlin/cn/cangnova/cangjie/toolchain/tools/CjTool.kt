...
abstract class CjTool(toolName: String, val toolchain: cn.cangnova.cangjie.toolchain.CjToolchainBase) {
...
abstract class CangJieComponent(componentName: String, toolchain: cn.cangnova.cangjie.toolchain.CjToolchainBase) :
