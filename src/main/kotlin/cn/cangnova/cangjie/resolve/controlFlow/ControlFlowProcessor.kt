...
import cn.cangnova.cangjie.contracts.description.canBeRevisited
import cn.cangnova.cangjie.contracts.description.isDefinitelyVisited
...
import cn.cangnova.cangjie.resolve.CompileTimeConstantUtils
import cn.cangnova.cangjie.resolve.calls.model.ArgumentMatch
...
import cn.cangnova.cangjie.resolve.controlFlow.pseudocode.*
import cn.cangnova.cangjie.resolve.controlFlow.pseudocode.instructions.eval.AccessTarget
import cn.cangnova.cangjie.resolve.controlFlow.pseudocode.instructions.eval.InstructionWithValue
import cn.cangnova.cangjie.resolve.controlFlow.pseudocode.instructions.eval.MagicKind
import cn.cangnova.cangjie.resolve.scopes.receivers.*
...
class ControlFlowProcessor(
    ...
    private inner class CFPVisitor(private val builder: ControlFlowBuilder) : CjVisitorVoid() {
