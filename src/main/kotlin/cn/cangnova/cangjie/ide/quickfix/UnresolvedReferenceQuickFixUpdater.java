...
//
///**
// * Call each registered {@link com.intellij.codeInsight.quickfix.UnresolvedReferenceQuickFixProvider} for its quick fixes.
// * It does roughly the same as {@link com.intellij.codeInsight.quickfix.UnresolvedReferenceQuickFixProvider#registerReferenceFixes(PsiReference, QuickFixActionRegistrar)}, except:
// * 1) each {@link com.intellij.codeInsight.quickfix.UnresolvedReferenceQuickFixProvider#registerFixes(PsiReference, QuickFixActionRegistrar)} is called in the background and
// * 2) in the lazy manner (no more than two providers in parallel).
// * That way we make highlighting to complete faster (because fewer {@link com.intellij.codeInsight.quickfix.UnresolvedReferenceQuickFixProvider}s are called)
...
//   * This call triggers background calculation of quick fixes supplied by {@link com.intellij.codeInsight.quickfix.UnresolvedReferenceQuickFixProvider}
