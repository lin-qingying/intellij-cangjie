...
public final class DirectClassInheritorsSearch extends ExtensibleQueryFactory<CjTypeStatement, DirectClassInheritorsSearch.SearchParameters> {
    public static final ExtensionPointName<QueryExecutor<CjTypeStatement, SearchParameters>> EP_NAME = ExtensionPointName.create("cn.cangnova.cangjie.ide.search.directClassInheritorsSearch");
