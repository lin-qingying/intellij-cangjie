...
import cn.cangnova.cangjie.ide.imports.isImported
...
private val LOG = Logger.getInstance("#cn.cangnova.cangjie.ide.refactoring.move.MoveUtil")
...
internal fun addDelayedImportRequest(elementToImport: PsiElement, file: CjFile) {
    cn.cangnova.cangjie.ide.codeinsight.shorten.addDelayedImportRequest(elementToImport, file)
}
