...
import cn.cangnova.cangjie.icon.CangJieIcons.ABSTRACT_CLASS
import cn.cangnova.cangjie.icon.CangJieIcons.ABSTRACT_EXTENSION_FUNCTION
import cn.cangnova.cangjie.icon.CangJieIcons.CLASS
import cn.cangnova.cangjie.icon.CangJieIcons.ENUM
import cn.cangnova.cangjie.icon.CangJieIcons.EXTENSION_FUNCTION
import cn.cangnova.cangjie.icon.CangJieIcons.FIELD_LET
import cn.cangnova.cangjie.icon.CangJieIcons.FIELD_MPROP
import cn.cangnova.cangjie.icon.CangJieIcons.FIELD_PROP
import cn.cangnova.cangjie.icon.CangJieIcons.FIELD_VAR
import cn.cangnova.cangjie.icon.CangJieIcons.FILE
import cn.cangnova.cangjie.icon.CangJieIcons.FUNCTION
import cn.cangnova.cangjie.icon.CangJieIcons.INTERFACE
import cn.cangnova.cangjie.icon.CangJieIcons.LAMBDA
import cn.cangnova.cangjie.icon.CangJieIcons.PARAMETER
import cn.cangnova.cangjie.icon.CangJieIcons.STRUCT
import cn.cangnova.cangjie.icon.CangJieIcons.TYPE_ALIAS
import cn.cangnova.cangjie.lexer.CjTokens
import cn.cangnova.cangjie.psi.*
import cn.cangnova.cangjie.psi.psiUtil.getStrictParentOfType
import cn.cangnova.cangjie.psi.psiUtil.isAbstract
import cn.cangnova.cangjie.psi.psiUtil.isPrivate
