...
package cn.cangnova.cangjie.ide.project.structure
...
abstract class CangJieBinaryExtension(val fileType: FileType) {
    companion object {
        val EP_NAME: ExtensionPointName<CangJieBinaryExtension> = ExtensionPointName.create("cn.cangnova.cangjie.binaryExtension")
