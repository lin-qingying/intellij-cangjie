...
/**
 * Data class representing a kind of [cn.cangnova.cangjie.ide.completion.turboComplete.SuggestionGenerator]'s suggestions.
 *
 * Each completion kind belongs to a kind variety.
 * The completion kind's name is defined statically, it should be unique among
 * the corresponding [cn.cangnova.cangjie.ide.completion.turboComplete.KindVariety].
 */
