...
import cn.cangnova.cangjie.IterableTypesDetection
import cn.cangnova.cangjie.TypesWithContainsDetector
...
import cn.cangnova.cangjie.resolve.getTargetFunctionDescriptor
import cn.cangnova.cangjie.resolve.ideService
            ...
            if (operationToken == CjTokens.EQ || operationToken in COMPARISON_TOKENS) {
                ...
                if (otherOperand != null) {
                    ...
                    if (operationToken in COMPARISON_TOKENS) {
                        ...
                        expectedType = expectedType.makeOptional()
                    }
...
//    }
    ...
    private fun calculateForInitializer(expressionWithType: CjExpression): Collection<ExpectedInfo>? {
        val property = expressionWithType.parent as? CjProperty ?: return null
