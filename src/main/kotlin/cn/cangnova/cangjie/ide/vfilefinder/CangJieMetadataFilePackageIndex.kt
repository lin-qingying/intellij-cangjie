...
class CangJieMetadataFileIndex :CangJieMetadataFileIndexBase(ClassId::asSingleFqName) {
    companion object {
        val NAME: ID<FqName, Void> = ID.create("cn.cangnova.cangjie.ide.vfilefinder.CangJieMetadataFileIndex")
    }
...
class CangJieMetadataFilePackageIndex : CangJieMetadataFileIndexBase(ClassId::packageFqName) {
    companion object {
        val NAME: ID<FqName, Void> = ID.create("cn.cangnova.cangjie.ide.vfilefinder.CangJieMetadataFilePackageIndex")
    }
...
class CangJieBuiltInsMetadataIndex : CangJieFileIndexBase() {
    companion object {
        val NAME: ID<FqName, Void> = ID.create("cn.cangnova.cangjie.ide.vfilefinder.CangJieBuiltInsMetadataIndex")
    }
