...
import cn.cangnova.cangjie.psi.psiUtil.StubUtils;
...
import cn.cangnova.cangjie.psi.stubs.impl.CangJieClassStubImpl;
import cn.cangnova.cangjie.psi.stubs.impl.CangJieInterfaceStubImpl;
import cn.cangnova.cangjie.psi.stubs.impl.CangJieStructStubImpl;
import cn.cangnova.cangjie.psi.stubs.impl.Utils;
...
public class CjStructElementType extends CjStubElementType<CangJieStructStub, CjStruct> {
    ...
    public static CjStructElementType getStubType() {
        return   CjStubElementTypes.STRUCT;
    }
    @Override
