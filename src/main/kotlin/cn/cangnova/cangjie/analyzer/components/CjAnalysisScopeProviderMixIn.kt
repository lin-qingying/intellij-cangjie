...
package cn.cangnova.cangjie.analyzer.components
...
import cn.cangnova.cangjie.analyzer.lifetime.withValidityAssertion
import cn.cangnova.cangjie.ide.completion.providers.CangJieResolutionScopeProvider
import cn.cangnova.cangjie.psi.psiUtil.contains
...
interface CjAnalysisScopeProviderMixIn : CjAnalysisSessionMixIn {
     ...
     * That means [cn.cangnova.cangjie.analysis.api.symbols.CjSymbol] can be built by this [PsiElement]
     *
     * @see analysisScope
     */
