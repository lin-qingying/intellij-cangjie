...
%xstate STRING_PREFIX HSAH_STRING_SINGLE HSAH_STRING_DOUBLE STRING_SINGLE STRING_DOUBLE RAW_STRING_SINGLE RAW_STRING_DOUBLE SHORT_TEMPLATE_ENTRY BLOCK_COMMENT DOC_COMMENT LONG_TEMPLATE_ENTRY UNMATCHED_BACKTICK
...
PLAIN_IDENTIFIER={IDENTIFIER_START}{IDENTIFIER_PART}*
...
HEX_INTEGER_LITERAL=0[Xx]({HEX_DIGIT}({HEX_DIGIT_OR_UNDERSCORE}*{HEX_DIGIT})?)
BIN_INTEGER_LITERAL=0[Bb]({BIN_DIGIT}({BIN_DIGIT_OR_UNDERSCORE}*{BIN_DIGIT})?)
OCT_INTEGER_LITERAL=0[Oo]({OCT_DIGIT}({OCT_DIGIT_OR_UNDERSCORE}*{OCT_DIGIT})?)

FLOAT_SUFFIX=(f32|f16|f64)
FLOAT_LITERAL=({FLOAT_LITERAL_POINT}|{HEX_FLOATING_POINT_LITERAL}){FLOAT_SUFFIX}?
FLOAT_LITERAL_POINT=({FLOATING_POINT_LITERAL1}|{FLOATING_POINT_LITERAL2}|{FLOATING_POINT_LITERAL3})
...
HEX_FLOATING_POINT_LITERAL1=0[xX]({HEX_DIGIT}({HEX_DIGIT_OR_UNDERSCORE}*{HEX_DIGIT})?)"."({HEX_DIGIT}({HEX_DIGIT_OR_UNDERSCORE}*{HEX_DIGIT})?)"p"[+-]?{DIGITS}
HEX_FLOATING_POINT_LITERAL2=0[xX]"."({HEX_DIGIT}({HEX_DIGIT_OR_UNDERSCORE}*{HEX_DIGIT})?)"p"[+-]?{DIGITS}
HEX_FLOATING_POINT_LITERAL3=0[xX]({HEX_DIGIT}({HEX_DIGIT_OR_UNDERSCORE}*{HEX_DIGIT})?)"p"[+-]?{DIGITS}
...
<RAW_STRING_SINGLE> \n                  { return CjTokens.REGULAR_STRING_PART; }
<RAW_STRING_SINGLE> \" | \'             { return CjTokens.REGULAR_STRING_PART; }
<RAW_STRING_SINGLE> \\                  { return CjTokens.REGULAR_STRING_PART; }
...
<RAW_STRING_DOUBLE> \n                  { return CjTokens.REGULAR_STRING_PART; }
<RAW_STRING_DOUBLE> \" | \'             { return CjTokens.REGULAR_STRING_PART; }
<RAW_STRING_DOUBLE> \\                  { return CjTokens.REGULAR_STRING_PART; }
