...
public class CjValueParameterListImpl extends CjStubbedElementImpl<CjPlaceholderStub<?>> implements CjValueParameterList {

  public CjValueParameterListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public CjValueParameterListImpl(@NotNull CjPlaceholderStub<?> stub, @NotNull IStubElementType<?, ?> type) {
    super(stub, type);
  }
  ...
  @Override
  @NotNull
  public List<CjValueParameter> getValueParameterList() {
    return PsiTreeUtil.getStubChildrenOfTypeAsList(this, CjValueParameter.class);
  }
