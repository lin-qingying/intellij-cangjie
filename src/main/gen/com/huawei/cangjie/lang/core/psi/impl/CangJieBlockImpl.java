...
public class CangJieBlockImpl extends CjElementImpl implements CangJieBlock {
  ...
  @Override
  @NotNull
  public List<CangJieToBeUpped> getToBeUppedList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CangJieToBeUpped.class);
  }
