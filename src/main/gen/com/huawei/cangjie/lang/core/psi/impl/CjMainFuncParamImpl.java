...
public class CjMainFuncParamImpl extends CjElementImpl implements CjMainFuncParam {

  public CjMainFuncParamImpl(@NotNull IElementType type) {
    super(type);
  }

  public void accept(@NotNull CjVisitor visitor) {
    visitor.visitMainFuncParam(this);
  }
