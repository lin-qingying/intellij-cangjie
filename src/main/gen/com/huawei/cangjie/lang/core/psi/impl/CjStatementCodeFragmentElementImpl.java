...
public class CjStatementCodeFragmentElementImpl extends CjElementImpl implements CjStatementCodeFragmentElement {

  public CjStatementCodeFragmentElementImpl(@NotNull IElementType type) {
    super(type);
  }
  ...
  @Override
  @Nullable
  public CjStmt getStmt() {
    return PsiTreeUtil.getChildOfType(this, CjStmt.class);
  }
