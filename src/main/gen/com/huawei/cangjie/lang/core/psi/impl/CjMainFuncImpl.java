...
public class CjMainFuncImpl extends CjStubbedElementImpl<CjPlaceholderStub<?>> implements CjMainFunc {

  public CjMainFuncImpl(@NotNull ASTNode node) {
    super(node);
  }

  public CjMainFuncImpl(@NotNull CjPlaceholderStub<?> stub, @NotNull IStubElementType<?, ?> type) {
    super(stub, type);
  }
  ...
  @Override
  @Nullable
  public CjMainFuncParam getMainFuncParam() {
    return PsiTreeUtil.getChildOfType(this, CjMainFuncParam.class);
  }
