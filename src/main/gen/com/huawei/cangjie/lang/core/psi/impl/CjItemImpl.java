...
public class CjItemImpl extends CjElementImpl implements CjItem {

  public CjItemImpl(@NotNull IElementType type) {
    super(type);
  }
  ...
  @Override
  @Nullable
  public CjMainFunc getMainFunc() {
    return PsiTreeUtil.getChildOfType(this, CjMainFunc.class);
  }
