...
public class CjLifetimeParamBoundsImpl extends CjElementImpl implements CjLifetimeParamBounds {

  public CjLifetimeParamBoundsImpl(@NotNull IElementType type) {
    super(type);
  }
  ...
  @Override
  @NotNull
  public List<CjLifetime> getLifetimeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CjLifetime.class);
  }
