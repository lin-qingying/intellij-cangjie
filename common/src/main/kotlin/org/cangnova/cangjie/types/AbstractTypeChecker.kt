 ...
 * created by [org.cangnova.cangjie.types.model.TypeCheckerProviderContext.newTypeCheckerState] in most cases
 *
 * Stateful and shouldn't be reused
 *
 * Once some type-checker operation is performed using a [org.cangnova.cangjie.types.model.TypeCheckerProviderContext], for example a [AbstractTypeChecker.isSubtypeOf],
