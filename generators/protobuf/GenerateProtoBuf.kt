package com.huawei.cangjie.generators.protobuf
...
private const val PROTOC_EXE = "D:\\Code\\intellij\\intellij-cangjie\\generators\\protobuf\\protoc-27.2-win64\\bin\\protoc.exe"
...
private val EXT_OPTIONS_PROTO_PATH = ProtoPath("metadata/src/ext_options.proto")
private val PROTOBUF_PROTO_PATHS = listOf("./", "metadata/src")
val PROTO_PATHS: List<ProtoPath> = listOf(
    ProtoPath("metadata/src/metadata.proto"),
    ProtoPath("metadata/src/builtins.proto"),
    ProtoPath("metadata/src/properties_order_extension.proto", generateDebug = false),
    EXT_OPTIONS_PROTO_PATH
//    ProtoPath("js/js.serializer/src/js.proto"),
//    ProtoPath("js/js.serializer/src/js-ast.proto", false),
//    ProtoPath("metadata.jvm/src/jvm_metadata.proto"),
//    ProtoPath("metadata.jvm/src/jvm_module.proto"),
