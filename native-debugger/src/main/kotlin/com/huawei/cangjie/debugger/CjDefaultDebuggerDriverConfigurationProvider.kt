...
interface CjDebuggerDriverConfigurationProvider {
    ...
    companion object {
        ...
        val EP_NAME: ExtensionPointName<CjDebuggerDriverConfigurationProvider> =
            ExtensionPointName.create("com.huawei.cangjie.debugger.driverConfigurationProvider")
    }
}
...
//        SystemInfo.isWindows && Registry.`is`("com.huawei.cangjie.debugger.lldb.cangjie.msvc", false)
}
