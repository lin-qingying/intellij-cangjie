...
import org.cangnova.cangjie.completion.handlers.NamedArgumentInsertHandler
import org.cangnova.cangjie.name.Name
import org.cangnova.cangjie.psi.*
import org.cangnova.cangjie.psi.psiUtil.getStrictParentOfType
import org.cangnova.cangjie.resolve.ResolutionFacade
import org.cangnova.cangjie.resolve.caches.resolveToCall
import org.cangnova.cangjie.resolve.calls.components.isVararg
import org.cangnova.cangjie.resolve.calls.model.ResolvedCall
import org.cangnova.cangjie.resolve.calls.util.getParameterForArgument
 ...
 */
fun CjValueArgument.canBeUsedWithoutNameInCall(resolvedCall: ResolvedCall< CallableDescriptor>): Boolean {
...
//      if (languageVersionSettings.supportsFeature(LanguageFeature.MixedNamedArgumentsInTheirOwnPosition)) {
      return  argumentsBeforeThis.none { it.isNamed() && !it.placedOnItsOwnPositionInCall(resolvedCall) }
//    } else {
//    return   argumentsBeforeThis.none { it.isNamed() }
//    }
}
...
fun ValueArgument.placedOnItsOwnPositionInCall(resolvedCall: ResolvedCall< CallableDescriptor>): Boolean {
