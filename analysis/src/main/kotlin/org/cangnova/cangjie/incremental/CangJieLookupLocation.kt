...
import org.cangnova.cangjie.diagnostics.DiagnosticUtils.getLineAndColumnInPsiFile
import org.cangnova.cangjie.incremental.components.LocationInfo
        ...
        if (containingCjFile.doNotAnalyze != null)
            ...
            object : LocationInfo {
                ...
                override val position: Position
                    get() = getLineAndColumnInPsiFile(containingCjFile, element.textRange).let {
                        Position(
                            it.line,
                            it.column
                        )
