...
import org.cangnova.cangjie.refactoring.move.MoveDeclarationsDescriptor
import org.cangnova.cangjie.refactoring.move.getTargetModule
import org.cangnova.cangjie.lexer.CjTokens
import org.cangnova.cangjie.psi.CjNamedDeclaration
import org.cangnova.cangjie.resolve.scopes.projectScope
import org.cangnova.cangjie.utils.module
...
//        .mapValues { it.value.keysToMap { declaration -> declaration.toLightElements().ifEmpty { listOf(declaration) } } }
    ...
    public override fun findUsages(): Array<UsageInfo> {
        ...
        fun getSearchScope(element: PsiElement): GlobalSearchScope? {
            ...
            val cjDeclaration = element as? CjNamedDeclaration ?: return projectScope
