...
interface TypeAttributeTranslatorExtension : TypeAttributeTranslator {
    companion object {
        val EP_NAME =
            ExtensionPointName.create<TypeAttributeTranslatorExtension>("org.cangnova.cangjie.typeAttributeTranslatorExtension")
        ...
        fun createTranslators(project: Project): TypeAttributeTranslators {
            return TypeAttributeTranslators(EP_NAME.extensionList + DefaultTypeAttributeTranslator)
        }
    }
