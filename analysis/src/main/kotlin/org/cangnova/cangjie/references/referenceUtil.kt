...
internal fun Project.resolveClass(
    fqNameString: String,
    scope: GlobalSearchScope = GlobalSearchScope.allScope(this)
): PsiElement? =
...
private fun GlobalSearchScope.selectNearest(
    classesPsi: Collection<CjDeclaration>,
    typeAliasesPsi: Collection<CjTypeAlias>
): CjDeclaration? {
    val scope = this
    return when {
