...
import org.cangnova.cangjie.resolve.calls.util.getCalleeExpressionIfAny
import org.cangnova.cangjie.resolve.calls.util.getResolvedCall
import org.cangnova.cangjie.resolve.calls.util.resolveCandidates
...
import org.cangnova.cangjie.utils.runAction
...
import org.cangnova.cangjie.diagnostics.rendering.CommentSaver
...
//                    导入
    ...
    private class ShortenPackageProcessor(
        ...
        override fun analyzeQualifiedElement(
            ...
            val import = file.importDirectives.flatMap { it.importItems }.filter {
...
//            }
            ...
            val canShortenNow = import.isNotEmpty()
