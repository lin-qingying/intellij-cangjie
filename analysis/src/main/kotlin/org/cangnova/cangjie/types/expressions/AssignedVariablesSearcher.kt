...
abstract class AssignedVariablesSearcher : CjTreeVisitorUnit() {
    ...
    open fun writers(variableDescriptor: VariableDescriptor): MutableSet<Writer> =
        assignedNames[variableDescriptor.name]
