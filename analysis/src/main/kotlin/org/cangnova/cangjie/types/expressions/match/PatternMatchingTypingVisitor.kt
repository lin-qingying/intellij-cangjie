...
class TupleConstructor(val types: List<CangJieType>)
...
//        绑定模式解析枚举
    ...
    private fun resoleCasePattern(
        ...
        val patternVisitor = object : CjVisitorUnit() {
...
//            }
            ...
            return returnResult(
                element, data, Pattern(
                    data.subject.type,
                    PatternKind.Tuple(
                        element.patterns.mapIndexedNotNull { index, it ->
//                        期望类型
