        ...
        for (i in expandedTypes.indices) {
            ...
            for (j in i + 1 until expandedTypes.size) {
                ...
                when {
                    ...
                    firstType.lowerBoundIfFlexible()
                        .isSubtypeOfIgnoringArguments(typeCheckerState, secondTypeConstructor) ||
                            secondType.lowerBoundIfFlexible()
                                .isSubtypeOfIgnoringArguments(typeCheckerState, firstTypeConstructor) -> {
                    }
