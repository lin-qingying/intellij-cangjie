...
class InnerClassesScopeWrapper(val workerScope: MemberScope) : MemberScopeImpl() {
    ...
    override fun getContributedDescriptors(
        ...
        val restrictedFilter =
            kindFilter.restrictedToKindsOrNull(DescriptorKindFilter.CLASSIFIERS_MASK) ?: return listOf()
    ...
    override val variableNames get() = workerScope.variableNames
    override val classifierNames get() = workerScope.classifierNames
