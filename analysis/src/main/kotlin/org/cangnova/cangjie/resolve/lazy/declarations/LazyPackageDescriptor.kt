...
class LazyPackageDescriptor(
    ...
    override val declarationProvider: PackageMemberDeclarationProvider
) : PackageFragmentDescriptorImpl(module, fqName), LazyEntity {

    private val memberScope: MemberScope = LazyPackageMemberScope(resolveSession, declarationProvider, this)
