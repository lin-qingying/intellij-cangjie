...
//    private val languageVersionSettings: LanguageVersionSettings,
    ...
    private fun Context.findFunctionalTypesInConstraints(
        ...
        val dependentVariables =
            variableDependencyProvider.getShallowlyDependentVariables(typeVariableTypeConstructor)
                .orEmpty() + typeVariableTypeConstructor
                ...
                .mapNotNull { anotherArgument ->
                    when {
                        ...
                        anotherArgument.parameterTypesFromDeclaration == null || anotherArgument == argument -> null
                            ...
                            val argumentExpectedTypeConstructor =
                                argument.expectedType?.typeConstructor() ?: return@mapNotNull null
                            ...
                            val parameterTypesFromDeclarationOfRelatedLambda =
    ...
    private fun Context.createTypeVariablesForParameters(
        ...
        val allGroupedParameterTypes =
            parameterTypes.first().indices.map { i -> parameterTypes.map { it.getOrNull(i) } }
