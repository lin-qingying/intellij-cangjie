...
import org.cangnova.cangjie.resolve.calls.util.hasThisOrNoDispatchReceiver
import org.cangnova.cangjie.resolve.controlFlow.ControlFlowProcessor
    ...
    fun extractVariableDescriptorIfAny(
        ...
        if (instruction is VariableDeclarationInstruction) {
            ...
            if (target is AccessTarget.Declaration) {
                ...
                return variableDescriptorForDeclaration(
                    target.resolvedCall.resultingDescriptor
                )
            }
        }
        return null
