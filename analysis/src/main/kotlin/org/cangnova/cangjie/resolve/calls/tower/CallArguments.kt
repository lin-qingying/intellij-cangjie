...
import org.cangnova.cangjie.diagnostics.infos.errors.SPREAD_OF_LAMBDA_OR_CALLABLE_REFERENCE
...
import org.cangnova.cangjie.resolve.calls.components.CaseEnumArgument
...
fun checkNoSpread(context: BasicCallResolutionContext, valueArgument: ValueArgument) {
    valueArgument.getSpreadElement()?.let {
        context.trace.report(SPREAD_OF_LAMBDA_OR_CALLABLE_REFERENCE.on(it))
    }
}
