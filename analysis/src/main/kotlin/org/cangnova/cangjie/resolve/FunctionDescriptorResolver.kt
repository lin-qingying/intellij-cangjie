...
import org.cangnova.cangjie.descriptors.macro.MacroDescriptorImpl
import org.cangnova.cangjie.diagnostics.PsiDiagnosticUtils
import org.cangnova.cangjie.diagnostics.infos.errors.*
import org.cangnova.cangjie.lexer.CjTokens
import org.cangnova.cangjie.name.Name
import org.cangnova.cangjie.psi.*
import org.cangnova.cangjie.psi.psiUtil.isEmptyBody
import org.cangnova.cangjie.resolve.DescriptorResolver.Companion.getDefaultModality
...
import org.cangnova.cangjie.resolve.calls.DslMarkerUtils
...
import org.cangnova.cangjie.resolve.scopes.TraceBasedLocalRedeclarationChecker
...
//            ExpressionTypingUtils.checkVariableShadowing(parameterScope, trace, valueParameterDescriptor)
    ...
    private fun createConstructorDescriptor(
        ...
        val constructorDescriptor = ClassConstructorDescriptorImpl.create(
            classDescriptor,
            annotationResolver.resolveAnnotationsWithoutArguments(scope, annotations, trace),
            isPrimary,
        ...
        if (isEnd) {
            constructor.setReturnType(builtIns.unitType)

        } else {
            constructor.setReturnType(classDescriptor.defaultType)
...
//这是扩展方法
    ...
    private fun resolveFunctionDescriptor(
        ...
        val functionDescriptor = functionConstructor(
            containingDescriptor,
            annotationResolver.resolveAnnotationsWithoutArguments(scope, function.annotations, trace),
