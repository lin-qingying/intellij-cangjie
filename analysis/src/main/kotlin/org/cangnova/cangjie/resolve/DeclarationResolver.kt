...
import org.cangnova.cangjie.diagnostics.infos.errors.PACKAGE_OR_CLASSIFIER_REDECLARATION
...
import org.cangnova.cangjie.resolve.lazy.TopLevelDescriptorProvider
        ...
        for ((fqName, declarationsOrPackageDirectives) in topLevelFqNames.asMap()) {
            ...
            val (expected, actual) =
                getTopLevelDescriptorsByFqName(
                    ...
                    .partition { it is MemberDescriptor }
            ...
            for (descriptors in listOf(expected, actual)) {
                if (descriptors.size > 1) {
                    ...
                    for (directive in declarationsOrPackageDirectives) {
                        ...
                        trace.report(
                            PACKAGE_OR_CLASSIFIER_REDECLARATION.on(
                                reportAt,
