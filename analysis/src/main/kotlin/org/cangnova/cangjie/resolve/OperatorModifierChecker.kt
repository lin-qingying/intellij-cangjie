...
import org.cangnova.cangjie.diagnostics.infos.errors.INAPPLICABLE_OPERATOR_MODIFIER
import org.cangnova.cangjie.diagnostics.infos.errors.UNSUPPORTED_FEATURE
import org.cangnova.cangjie.lexer.CjTokens
import org.cangnova.cangjie.psi.CjDeclaration
import org.cangnova.cangjie.utils.CheckResult
import org.cangnova.cangjie.utils.OperatorChecks
...
//            }
        ...
        diagnosticHolder.report(INAPPLICABLE_OPERATOR_MODIFIER.on(modifier, errorDescription))
    }
    ...
    private fun checkSupportsFeature(
        ...
        if (!languageVersionSettings.supportsFeature(feature)) {
            diagnosticHolder.report(UNSUPPORTED_FEATURE.on(modifier, feature to languageVersionSettings))
        }
    }
}
