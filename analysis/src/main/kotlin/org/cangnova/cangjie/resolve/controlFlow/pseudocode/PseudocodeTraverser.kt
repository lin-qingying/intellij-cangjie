...
package org.cangnova.cangjie.cfg.pseudocodeTraverser
...
import org.cangnova.cangjie.resolve.controlFlow.pseudocode.instructions.special.InlinedLocalFunctionDeclarationInstruction
import org.cangnova.cangjie.resolve.controlFlow.pseudocode.instructions.special.LocalFunctionDeclarationInstruction
import org.cangnova.cangjie.resolve.controlFlow.pseudocode.instructions.special.SubroutineEnterInstruction
import org.cangnova.cangjie.resolve.controlFlow.pseudocode.instructions.special.SubroutineSinkInstruction
import org.cangnova.cangjie.cfg.pseudocodeTraverser.TraversalOrder.FORWARD
import java.util.*
...
private fun <I : ControlFlowInfo<*, *, *>> Pseudocode.collectDataFromSubgraph(
    ...
    for (instruction in instructions) {
        ...
        if (instruction is LocalFunctionDeclarationInstruction) {
            ...
            val lastInstruction =
                if (instruction is InlinedLocalFunctionDeclarationInstruction && traversalOrder == FORWARD)
            ...
            val updatedValue = newValue?.let {
                Edges(
                    updateEdge(lastInstruction, instruction, it.incoming),
                    updateEdge(lastInstruction, instruction, it.outgoing)
                )
            }
