...
abstract class CjContractDescriptionVisitor<out R, in D, Type, Diagnostic> {
    open fun visitContractDescriptionElement(
        contractDescriptionElement: CjContractDescriptionElement<Type, Diagnostic>,
        data: D
    ): R {
    ...
    // Effects
    open fun visitEffectDeclaration(effectDeclaration: CjEffectDeclaration<Type, Diagnostic>, data: D): R =
