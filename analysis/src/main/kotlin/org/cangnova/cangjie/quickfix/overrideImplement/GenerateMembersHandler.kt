...
import org.cangnova.cangjie.resolve.deprecation.findCallableMemberBySignature
    ...
    if (otherMembers.isNotEmpty()) {
        ...
        otherMembers.mapTo(insertedMembers) {
            ...
            if (classOrObject is CjClass && classOrObject.isEnum()) {
                val enumEntries = classOrObject.declarations.filterIsInstance<CjEnumConstructor>()
