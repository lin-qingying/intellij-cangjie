...
package org.cangnova.cangjie.search.findUsages
...
import org.cangnova.cangjie.search.isCangJieConstructorUsage
...
class CangJieFindUsagesSupportImpl : CangJieFindUsagesSupport {
    override fun getSuperMethods(declaration:CjDeclaration, ignore: Collection<PsiElement>?): List<PsiElement> =
        org.cangnova.cangjie .refactoring.getSuperMethods(declaration, ignore)
    override fun tryRenderDeclarationCompactStyle(declaration: CjDeclaration): String? =
        org.cangnova.cangjie.search.  tryRenderDeclarationCompactStyle(declaration)
