...
import org.cangnova.cangjie.search.ExpressionsOfTypeProcessor
import org.cangnova.cangjie.search.ExpressionsOfTypeProcessor.Companion.logPresentation
import org.cangnova.cangjie.search.ExpressionsOfTypeProcessor.Companion.testLog
...
import org.cangnova.cangjie.messages.CangJieBaseAnalysisBundle
...
import org.cangnova.cangjie.search.CangJieSearchUsagesSupport.SearchUtils.forceResolveReferences
import org.cangnova.cangjie.search.CangJieSearchUsagesSupport.SearchUtils.getReceiverTypeSearcherInfo
    ...
    private fun doPlainSearch(scope: SearchScope) {
        ...
        if (scope is LocalSearchScope) {
            ...
            if (wordsToSearch.isNotEmpty()) {
                val unwrappedElement = targetDeclaration
