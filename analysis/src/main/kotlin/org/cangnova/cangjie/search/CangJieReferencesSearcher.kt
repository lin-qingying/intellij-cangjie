...
import org.cangnova.cangjie.search.ideExtensions.CangJieAwareReferencesSearchParameters
import org.cangnova.cangjie.search.ideExtensions.CangJieReferencesSearchOptions.Companion.Empty
import org.cangnova.cangjie.search.ideExtensions.CangJieReferencesSearchOptions.Companion.calculateEffectiveScope
import org.cangnova.cangjie.search.ideExtensions.CangJieRequestResultProcessor
import org.cangnova.cangjie.search.operators.OperatorReferenceSearcher
        ...
        fun process() {
            ...
            val (elementToSearchPointer: SmartPsiElementPointer<PsiNamedElement>, effectiveSearchScope) = ReadAction.nonBlocking(
                Callable {
                    ...
                    val unwrappedElement = psiElement ?: return@Callable null
                    ...
                    // 确保 elementToSearch 是 PsiNamedElement 类型
                    if (elementToSearch !is PsiNamedElement) return@Callable null
...
//                }
        ...
        private fun searchNamedElement(
            ...
            val resultProcessor = CangJieRequestResultProcessor(
                element,
                queryParameters.elementToSearch ?: element,
