...
open class CangJieFindUsagesProviderBase : FindUsagesProvider {
    ...
    override fun getType(element: PsiElement): String {
        return when (element) {
            is CjBindingPattern -> CangJieSearchBundle.message("find.usages.variable")
            ...
            is CjSecondaryConstructor -> CangJieSearchBundle.message("find.usages.constructor")
    ...
    override fun getDescriptiveName(element: PsiElement): String {
        return when (element) {
            ...
            is CjTypeStatement -> {
                ...
                } ?: element.name ?: CangJieSearchBundle.message("usage.provider.text.unnamed")
            }
            /*is CjProperty ,*/is CjVariable<*> -> {
                val name = element.name ?: ""
                element.containerDescription?.let {
                    CangJieSearchBundle.message(
...
//                    val name = element.name ?: ""
//                    element.containerDescription?.let { CangJieSearchBundle.message("usage.provider.text.property.of.0", name, it) } ?: name
//                } else {
                element.name ?: ""
//                }
            }
