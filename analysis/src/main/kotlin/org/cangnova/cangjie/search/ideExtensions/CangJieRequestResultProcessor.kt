...
package org.cangnova.cangjie.search.ideExtensions
...
import org.cangnova.cangjie.scope.allScope
...
//        if (this is CjDestructuringDeclarationReference) return true
    ...
    private fun PsiReference.isReferenceToTarget(element: PsiElement): Boolean {
        ...
        if (resolve()== element.originalElement) {
            return true
        }
...
class CangJieReferencesSearchParameters(
    ...
    CangJieAwareReferencesSearchParameters
